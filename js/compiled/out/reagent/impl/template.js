...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25652__auto__,writer__25653__auto__,opt__25654__auto__){
return cljs.core._write.call(null,writer__25653__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__128944 = o;
(G__128944[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__128945__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__128945 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__128946__i = 0, G__128946__a = new Array(arguments.length -  0);
while (G__128946__i < G__128946__a.length) {G__128946__a[G__128946__i] = arguments[G__128946__i + 0]; ++G__128946__i;}
  args = new cljs.core.IndexedSeq(G__128946__a,0);
} 
return G__128945__delegate.call(this,args);};
G__128945.cljs$lang$maxFixedArity = 0;
G__128945.cljs$lang$applyTo = (function (arglist__128947){
var args = cljs.core.seq(arglist__128947);
return G__128945__delegate(args);
});
G__128945.cljs$core$IFn$_invoke$arity$variadic = G__128945__delegate;
return G__128945;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__25034__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25034__auto__){
var and__25034__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__128953 = jsprops;
(G__128953["defaultValue"] = value);

(G__128953["onChange"] = ((function (G__128953,v,value,on_change){
return (function (p1__128950_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__128950_SHARP_);
});})(G__128953,v,value,on_change))
);

(G__128953["ref"] = ((function (G__128953,v,value,on_change){
return (function (p1__128951_SHARP_){
return (this$["cljsInputElement"] = p1__128951_SHARP_);
});})(G__128953,v,value,on_change))
);
...
var vec__128960 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__128960,(0),null);
var id = cljs.core.nth.call(null,vec__128960,(1),null);
var class$ = cljs.core.nth.call(null,vec__128960,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___128965 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___128965 == null)){
} else {
var key_128966 = temp__4661__auto___128965;
(jsprops["key"] = key_128966);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__128968 = (new reagent.impl.template.NativeWrapper());
(G__128968["name"] = c);

(G__128968["id"] = null);

(G__128968["class"] = null);
...
var len__26121__auto___128974 = arguments.length;
var i__26122__auto___128975 = (0);
while(true){
if((i__26122__auto___128975 < len__26121__auto___128974)){
args__26128__auto__.push((arguments[i__26122__auto___128975]));

var G__128976 = (i__26122__auto___128975 + (1));
i__26122__auto___128975 = G__128976;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__26129__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq128972){
var G__128973 = cljs.core.first.call(null,seq128972);
var seq128972__$1 = cljs.core.next.call(null,seq128972);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__128973,seq128972__$1);
});
...
break;
default:
var G__128980 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__128980;
continue;
...
var n__25961__auto___128983 = a.length;
var i_128984 = (0);
while(true){
if((i_128984 < n__25961__auto___128983)){
(a[i_128984] = reagent.impl.template.as_element.call(null,(a[i_128984])));

var G__128985 = (i_128984 + (1));
i_128984 = G__128985;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25961__auto___128986 = a.length;
var i_128987 = (0);
while(true){
if((i_128987 < n__25961__auto___128986)){
var val_128988 = (a[i_128987]);
if((cljs.core.vector_QMARK_.call(null,val_128988)) && ((reagent.impl.template.key_from_vec.call(null,val_128988) == null))){
(o["no-key"] = true);
} else {
}

(a[i_128987] = reagent.impl.template.as_element.call(null,val_128988));

var G__128989 = (i_128987 + (1));
i_128987 = G__128989;
continue;
} else {
}
...
var ctx = ({});
var vec__128993 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__128993,(0),null);
var derefed = cljs.core.nth.call(null,vec__128993,(1),null);
...
var G__128997 = (cljs.core.count.call(null,argv) - first_child);
switch (G__128997) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__128997){
...
//# sourceMappingURL=template.js.map?rel=1484099798568