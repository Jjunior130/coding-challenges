...
var G__49468 = o;
(G__49468[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__49470__i < G__49470__a.length) {G__49470__a[G__49470__i] = arguments[G__49470__i + 0]; ++G__49470__i;}
  args = new cljs.core.IndexedSeq(G__49470__a,0);
} 
...
var G__49477 = jsprops;
(G__49477["defaultValue"] = value);

(G__49477["onChange"] = ((function (G__49477,v,value,on_change){
return (function (p1__49474_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__49474_SHARP_);
});})(G__49477,v,value,on_change))
);

(G__49477["ref"] = ((function (G__49477,v,value,on_change){
return (function (p1__49475_SHARP_){
return (this$["cljsInputElement"] = p1__49475_SHARP_);
});})(G__49477,v,value,on_change))
);
...
var vec__49484 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__49484,(0),null);
var id = cljs.core.nth.call(null,vec__49484,(1),null);
var class$ = cljs.core.nth.call(null,vec__49484,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___49489 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___49489 == null)){
} else {
var key_49490 = temp__4661__auto___49489;
(jsprops["key"] = key_49490);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__49492 = (new reagent.impl.template.NativeWrapper());
(G__49492["name"] = c);
...
var len__26121__auto___49498 = arguments.length;
var i__26122__auto___49499 = (0);
while(true){
if((i__26122__auto___49499 < len__26121__auto___49498)){
args__26128__auto__.push((arguments[i__26122__auto___49499]));

var G__49500 = (i__26122__auto___49499 + (1));
i__26122__auto___49499 = G__49500;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq49496){
var G__49497 = cljs.core.first.call(null,seq49496);
var seq49496__$1 = cljs.core.next.call(null,seq49496);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__49497,seq49496__$1);
});
...
break;
default:
var G__49504 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__49504;
continue;
...
var n__25961__auto___49507 = a.length;
var i_49508 = (0);
while(true){
if((i_49508 < n__25961__auto___49507)){
(a[i_49508] = reagent.impl.template.as_element.call(null,(a[i_49508])));
...
var a = cljs.core.into_array.call(null,s);
var n__25961__auto___49510 = a.length;
var i_49511 = (0);
while(true){
if((i_49511 < n__25961__auto___49510)){
var val_49512 = (a[i_49511]);
if((cljs.core.vector_QMARK_.call(null,val_49512)) && ((reagent.impl.template.key_from_vec.call(null,val_49512) == null))){
(o["no-key"] = true);
} else {
}

(a[i_49511] = reagent.impl.template.as_element.call(null,val_49512));

var G__49513 = (i_49511 + (1));
i_49511 = G__49513;
continue;
} else {
}
...
var ctx = ({});
var vec__49517 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__49517,(0),null);
var derefed = cljs.core.nth.call(null,vec__49517,(1),null);
...
var G__49521 = (cljs.core.count.call(null,argv) - first_child);
switch (G__49521) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__49521){
...
//# sourceMappingURL=template.js.map?rel=1484333375870