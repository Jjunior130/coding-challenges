...
return precompiled45456.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.collect_one], null));
} else {
return precompiled45456;
}
})(),(function (xdir,x){
return (x + ((5) * xdir));
}),ship);
...
coding_challenges.space_invaders.ship.draw = (function coding_challenges$space_invaders$ship$draw(p__45457){
var map__45460 = p__45457;
var map__45460__$1 = ((((!((map__45460 == null)))?((((map__45460.cljs$lang$protocol_mask$partition0$ & (64))) || (map__45460.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45460):map__45460);
var ship = map__45460__$1;
var x = cljs.core.get.call(null,map__45460__$1,new cljs.core.Keyword(null,"x","x",2099068185));
...
//# sourceMappingURL=ship.js.map?rel=1484782598434