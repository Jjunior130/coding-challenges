...
return precompiled61908.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.collect_one], null));
} else {
return precompiled61908;
}
})(),(function (xdir,x){
return (x + ((5) * xdir));
}),ship);
...
coding_challenges.space_invaders.ship.draw = (function coding_challenges$space_invaders$ship$draw(p__61909){
var map__61912 = p__61909;
var map__61912__$1 = ((((!((map__61912 == null)))?((((map__61912.cljs$lang$protocol_mask$partition0$ & (64))) || (map__61912.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61912):map__61912);
var ship = map__61912__$1;
var x = cljs.core.get.call(null,map__61912__$1,new cljs.core.Keyword(null,"x","x",2099068185));
...
//# sourceMappingURL=ship.js.map?rel=1484333402735