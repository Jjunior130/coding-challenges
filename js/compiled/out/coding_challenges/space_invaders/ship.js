...
return precompiled35115.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.collect_one], null));
} else {
return precompiled35115;
}
})(),(function (xdir,x){
return (x + ((5) * xdir));
}),ship);
...
coding_challenges.space_invaders.ship.draw = (function coding_challenges$space_invaders$ship$draw(p__35116){
var map__35119 = p__35116;
...
var ship = map__35119__$1;
var x = cljs.core.get.call(null,map__35119__$1,new cljs.core.Keyword(null,"x","x",2099068185));
...
//# sourceMappingURL=ship.js.map?rel=1484456851618