...
return precompiled32913.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.collect_one], null));
} else {
return precompiled32913;
}
})(),(function (xdir,x){
return (x + ((5) * xdir));
}),ship);
...
coding_challenges.space_invaders.ship.draw = (function coding_challenges$space_invaders$ship$draw(p__32914){
var map__32917 = p__32914;
...
var ship = map__32917__$1;
var x = cljs.core.get.call(null,map__32917__$1,new cljs.core.Keyword(null,"x","x",2099068185));
...
//# sourceMappingURL=ship.js.map?rel=1484702590112