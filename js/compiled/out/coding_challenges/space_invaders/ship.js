...
return precompiled35093.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [com.rpl.specter.collect_one], null));
} else {
return precompiled35093;
}
})(),(function (xdir,x){
return (x + ((5) * xdir));
}),ship);
...
coding_challenges.space_invaders.ship.draw = (function coding_challenges$space_invaders$ship$draw(p__35094){
var map__35097 = p__35094;
...
var ship = map__35097__$1;
var x = cljs.core.get.call(null,map__35097__$1,new cljs.core.Keyword(null,"x","x",2099068185));
...
//# sourceMappingURL=ship.js.map?rel=1484366731324