...
var len__7484__auto___38618 = arguments.length;
var i__7485__auto___38619 = (0);
while(true){
if((i__7485__auto___38619 < len__7484__auto___38618)){
args__7491__auto__.push((arguments[i__7485__auto___38619]));

var G__38620 = (i__7485__auto___38619 + (1));
i__7485__auto___38619 = G__38620;
continue;
} else {
}
break;
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38616){
var G__38617 = cljs.core.first.call(null,seq38616);
var seq38616__$1 = cljs.core.next.call(null,seq38616);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38617,seq38616__$1);
});
...
return (p1__38621_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1485243290129