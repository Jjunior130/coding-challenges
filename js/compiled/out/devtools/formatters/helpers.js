...
var G__49061 = devtools.prefs.pref.call(null,v);
v = G__49061;
continue;
} else {
return v;
...
}catch (e49074){var e__48823__auto__ = e49074;
return false;
}})();
...
}catch (e49078){var e__48823__auto__ = e49078;
return false;
}})();
...
}catch (e49080){var e__48823__auto__ = e49080;
return false;
}}
}
});
...
var vec__49085 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__49085,(0),null);
var name = cljs.core.nth.call(null,vec__49085,(1),null);
...
return cljs.core.some.call(null,(function (p1__49088_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__49088_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484163026703