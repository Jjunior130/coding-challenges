...
var G__38290 = devtools.prefs.pref.call(null,v);
v = G__38290;
continue;
} else {
return v;
...
var and__6397__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__6397__auto__){
var and__6397__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__6409__auto__ = (function (){try{if(!((value == null))){
...
}catch (e38303){var e__36344__auto__ = e38303;
return false;
}})();
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
var or__6409__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e38307){var e__36344__auto__ = e38307;
return false;
}})();
...
}catch (e38309){var e__36344__auto__ = e38309;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__6397__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__6397__auto__)){
var and__6397__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__6397__auto____$1){
...
var and__6397__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__6397__auto__)){
...
var or__6409__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
...
var and__6397__auto__ = (function (){var or__6409__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
...
var vec__38314 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38314,(0),null);
var name = cljs.core.nth.call(null,vec__38314,(1),null);
...
var and__6397__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__6397__auto__)){
...
var or__6409__auto__ = typeof value === 'string';
if(or__6409__auto__){
return or__6409__auto__;
} else {
var or__6409__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__38317_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38317_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484115262528