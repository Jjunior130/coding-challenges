...
var G__147813 = devtools.prefs.pref.call(null,v);
v = G__147813;
continue;
} else {
return v;
...
var and__25034__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25034__auto__){
var and__25034__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25046__auto__ = (function (){try{if(!((value == null))){
...
}catch (e147826){var e__65129__auto__ = e147826;
return false;
}})();
if(cljs.core.truth_(or__25046__auto__)){
return or__25046__auto__;
} else {
var or__25046__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e147830){var e__65129__auto__ = e147830;
return false;
}})();
...
}catch (e147832){var e__65129__auto__ = e147832;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25034__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25034__auto__)){
var and__25034__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25034__auto____$1){
...
var and__25034__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25034__auto__)){
...
var or__25046__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25046__auto__)){
return or__25046__auto__;
} else {
...
var and__25034__auto__ = (function (){var or__25046__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25046__auto__)){
return or__25046__auto__;
} else {
...
var vec__147837 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__147837,(0),null);
var name = cljs.core.nth.call(null,vec__147837,(1),null);
...
var and__25034__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25034__auto__)){
...
var or__25046__auto__ = typeof value === 'string';
if(or__25046__auto__){
return or__25046__auto__;
} else {
var or__25046__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__147840_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__147840_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484099836096