...
var G__48114 = devtools.prefs.pref.call(null,v);
v = G__48114;
continue;
} else {
return v;
...
}catch (e48127){var e__47876__auto__ = e48127;
return false;
}})();
...
}catch (e48131){var e__47876__auto__ = e48131;
return false;
}})();
...
}catch (e48133){var e__47876__auto__ = e48133;
return false;
}}
}
});
...
var vec__48138 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__48138,(0),null);
var name = cljs.core.nth.call(null,vec__48138,(1),null);
...
return cljs.core.some.call(null,(function (p1__48141_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__48141_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484702601857