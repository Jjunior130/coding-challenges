...
var G__38382 = devtools.prefs.pref.call(null,v);
v = G__38382;
continue;
} else {
return v;
...
}catch (e38395){var e__36436__auto__ = e38395;
return false;
}})();
...
}catch (e38399){var e__36436__auto__ = e38399;
return false;
}})();
...
}catch (e38401){var e__36436__auto__ = e38401;
return false;
}}
}
});
...
var vec__38406 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38406,(0),null);
var name = cljs.core.nth.call(null,vec__38406,(1),null);
...
return cljs.core.some.call(null,(function (p1__38409_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38409_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484441681179