...
var G__28193 = devtools.prefs.pref.call(null,v);
v = G__28193;
continue;
} else {
return v;
...
}catch (e28206){var e__26189__auto__ = e28206;
return false;
}})();
...
}catch (e28210){var e__26189__auto__ = e28210;
return false;
}})();
...
}catch (e28212){var e__26189__auto__ = e28212;
return false;
}}
}
});
...
var vec__28217 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28217,(0),null);
var name = cljs.core.nth.call(null,vec__28217,(1),null);
...
return cljs.core.some.call(null,(function (p1__28220_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28220_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1484456863417