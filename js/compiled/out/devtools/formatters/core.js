...
var and__6397__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__6397__auto__){
var or__6409__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e38864){var e__36436__auto__ = e38864;
return false;
...
}catch (e38866){var e__36436__auto__ = e38866;
return false;
...
}catch (e38872){var e__36436__auto__ = e38872;
return false;
...
}catch (e38874){var e__36436__auto__ = e38874;
return false;
...
}catch (e38880){var e__36436__auto__ = e38880;
return false;
}})())){
...
}catch (e38882){var e__36436__auto__ = e38882;
return false;
}})())){
...
var _STAR_current_state_STAR_38885 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__6409__auto__ = config;
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38885;
}});
});
...
return (function() { 
var G__38888__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e38887){var e = e38887;
console.error("CLJS DevTools internal error:",e);

return null;
}};
var G__38888 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38889__i = 0, G__38889__a = new Array(arguments.length -  0);
while (G__38889__i < G__38889__a.length) {G__38889__a[G__38889__i] = arguments[G__38889__i + 0]; ++G__38889__i;}
  args = new cljs.core.IndexedSeq(G__38889__a,0);
} 
return G__38888__delegate.call(this,args);};
G__38888.cljs$lang$maxFixedArity = 0;
G__38888.cljs$lang$applyTo = (function (arglist__38890){
var args = cljs.core.seq(arglist__38890);
return G__38888__delegate(args);
});
...
var pre_handler = (function (){var or__6409__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
...
var post_handler = (function (){var or__6409__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1484441682289