...
var len__26121__auto___68572 = arguments.length;
var i__26122__auto___68573 = (0);
while(true){
if((i__26122__auto___68573 < len__26121__auto___68572)){
args__26128__auto__.push((arguments[i__26122__auto___68573]));

var G__68574 = (i__26122__auto___68573 + (1));
i__26122__auto___68573 = G__68574;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq68569){
var G__68570 = cljs.core.first.call(null,seq68569);
var seq68569__$1 = cljs.core.next.call(null,seq68569);
var G__68571 = cljs.core.first.call(null,seq68569__$1);
var seq68569__$2 = cljs.core.next.call(null,seq68569__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__68570,G__68571,seq68569__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__68575_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__68575_SHARP_));
})))){
...
var map__68584 = opts;
var map__68584__$1 = ((((!((map__68584 == null)))?((((map__68584.cljs$lang$protocol_mask$partition0$ & (64))) || (map__68584.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68584):map__68584);
var markup_db = cljs.core.get.call(null,map__68584__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e68588){var e__66585__auto__ = e68588;
return false;
}})();
if(cljs.core.truth_(or__25046__auto__)){
return or__25046__auto__;
...
}catch (e68590){var e__66585__auto__ = e68590;
return false;
}}
})())){
...
var _STAR_current_state_STAR_68595 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__68596 = opts;
var map__68596__$1 = ((((!((map__68596 == null)))?((((map__68596.cljs$lang$protocol_mask$partition0$ & (64))) || (map__68596.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__68596):map__68596);
var markup_db = cljs.core.get.call(null,map__68596__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_68595;
}});
...
;
var temp__4655__auto___68601 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___68601)){
var managed_print_level_68602 = temp__4655__auto___68601;
var _STAR_print_level_STAR_68600_68603 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_68602;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_68600_68603,managed_print_level_68602,temp__4655__auto___68601,writer,opts,job_fn){
return (function (p1__68598_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__68598_SHARP_,null);
});})(_STAR_print_level_STAR_68600_68603,managed_print_level_68602,temp__4655__auto___68601,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_68600_68603;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1484333415971