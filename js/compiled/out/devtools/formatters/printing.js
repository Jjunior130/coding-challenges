...
var len__7484__auto___38627 = arguments.length;
var i__7485__auto___38628 = (0);
while(true){
if((i__7485__auto___38628 < len__7484__auto___38627)){
args__7491__auto__.push((arguments[i__7485__auto___38628]));

var G__38629 = (i__7485__auto___38628 + (1));
i__7485__auto___38628 = G__38629;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7492__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38624){
var G__38625 = cljs.core.first.call(null,seq38624);
var seq38624__$1 = cljs.core.next.call(null,seq38624);
var G__38626 = cljs.core.first.call(null,seq38624__$1);
var seq38624__$2 = cljs.core.next.call(null,seq38624__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38625,G__38626,seq38624__$2);
});
...
if(cljs.core.truth_((function (){var or__6409__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__7015__auto__,writer__7016__auto__,opt__7017__auto__){
return cljs.core._write.call(null,writer__7016__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__6397__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__6397__auto__){
var or__6409__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38630_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__38630_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__38639__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__6409__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38643){var e__36640__auto__ = e38643;
return false;
}})();
if(cljs.core.truth_(or__6409__auto__)){
return or__6409__auto__;
...
}catch (e38645){var e__36640__auto__ = e38645;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38650 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38651 = opts;
var map__38651__$1 = ((((!((map__38651 == null)))?((((map__38651.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38651.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38651):map__38651);
var markup_db = cljs.core.get.call(null,map__38651__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38650;
}});
...
;
var temp__4655__auto___38656 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38656)){
var managed_print_level_38657 = temp__4655__auto___38656;
var _STAR_print_level_STAR_38655_38658 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38657;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38655_38658,managed_print_level_38657,temp__4655__auto___38656,writer,opts,job_fn){
return (function (p1__38653_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38653_SHARP_,null);
});})(_STAR_print_level_STAR_38655_38658,managed_print_level_38657,temp__4655__auto___38656,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38655_38658;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1485242685747