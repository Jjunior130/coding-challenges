...
var len__26121__auto___48812 = arguments.length;
var i__26122__auto___48813 = (0);
while(true){
if((i__26122__auto___48813 < len__26121__auto___48812)){
args__26128__auto__.push((arguments[i__26122__auto___48813]));

var G__48814 = (i__26122__auto___48813 + (1));
i__26122__auto___48813 = G__48814;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq48809){
var G__48810 = cljs.core.first.call(null,seq48809);
var seq48809__$1 = cljs.core.next.call(null,seq48809);
var G__48811 = cljs.core.first.call(null,seq48809__$1);
var seq48809__$2 = cljs.core.next.call(null,seq48809__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__48810,G__48811,seq48809__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__48815_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__48815_SHARP_));
})))){
...
var map__48824 = opts;
var map__48824__$1 = ((((!((map__48824 == null)))?((((map__48824.cljs$lang$protocol_mask$partition0$ & (64))) || (map__48824.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48824):map__48824);
var markup_db = cljs.core.get.call(null,map__48824__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e48828){var e__48541__auto__ = e48828;
return false;
}})();
if(cljs.core.truth_(or__25046__auto__)){
return or__25046__auto__;
...
}catch (e48830){var e__48541__auto__ = e48830;
return false;
}}
})())){
...
var _STAR_current_state_STAR_48835 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__48836 = opts;
var map__48836__$1 = ((((!((map__48836 == null)))?((((map__48836.cljs$lang$protocol_mask$partition0$ & (64))) || (map__48836.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48836):map__48836);
var markup_db = cljs.core.get.call(null,map__48836__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_48835;
}});
...
;
var temp__4655__auto___48841 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___48841)){
var managed_print_level_48842 = temp__4655__auto___48841;
var _STAR_print_level_STAR_48840_48843 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_48842;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_48840_48843,managed_print_level_48842,temp__4655__auto___48841,writer,opts,job_fn){
return (function (p1__48838_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__48838_SHARP_,null);
});})(_STAR_print_level_STAR_48840_48843,managed_print_level_48842,temp__4655__auto___48841,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_48840_48843;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1484366742970