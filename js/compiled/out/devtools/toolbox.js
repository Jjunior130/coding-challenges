...
var args28678 = [];
var len__7484__auto___28684 = arguments.length;
var i__7485__auto___28685 = (0);
while(true){
if((i__7485__auto___28685 < len__7484__auto___28684)){
args28678.push((arguments[i__7485__auto___28685]));

var G__28686 = (i__7485__auto___28685 + (1));
i__7485__auto___28685 = G__28686;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox28681 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox28681 = (function (obj,header,style,tag,meta28682){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox28681.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_28683,meta28682__$1){
var self__ = this;
var _28683__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox28681(self__.obj,self__.header,self__.style,self__.tag,meta28682__$1));
});

devtools.toolbox.t_devtools$toolbox28681.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_28683){
var self__ = this;
var _28683__$1 = this;
return self__.meta28682;
});

devtools.toolbox.t_devtools$toolbox28681.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox28681.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox28681.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox28681.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox28681.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta28682","meta28682",-895636940,null)], null);
});

devtools.toolbox.t_devtools$toolbox28681.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox28681.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox28681";

devtools.toolbox.t_devtools$toolbox28681.cljs$lang$ctorPrWriter = (function (this__7015__auto__,writer__7016__auto__,opt__7017__auto__){
return cljs.core._write.call(null,writer__7016__auto__,"devtools.toolbox/t_devtools$toolbox28681");
});

devtools.toolbox.__GT_t_devtools$toolbox28681 = (function devtools$toolbox$__GT_t_devtools$toolbox28681(obj__$1,header__$1,style__$1,tag__$1,meta28682){
return (new devtools.toolbox.t_devtools$toolbox28681(obj__$1,header__$1,style__$1,tag__$1,meta28682));
});

}

return (new devtools.toolbox.t_devtools$toolbox28681(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1484456865570