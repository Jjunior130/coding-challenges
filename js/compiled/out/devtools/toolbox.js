...
var args49546 = [];
var len__26121__auto___49552 = arguments.length;
var i__26122__auto___49553 = (0);
while(true){
if((i__26122__auto___49553 < len__26121__auto___49552)){
args49546.push((arguments[i__26122__auto___49553]));

var G__49554 = (i__26122__auto___49553 + (1));
i__26122__auto___49553 = G__49554;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox49549 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox49549 = (function (obj,header,style,tag,meta49550){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox49549.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_49551,meta49550__$1){
var self__ = this;
var _49551__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox49549(self__.obj,self__.header,self__.style,self__.tag,meta49550__$1));
});

devtools.toolbox.t_devtools$toolbox49549.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_49551){
var self__ = this;
var _49551__$1 = this;
return self__.meta49550;
});

devtools.toolbox.t_devtools$toolbox49549.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox49549.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox49549.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox49549.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox49549.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta49550","meta49550",56448403,null)], null);
});

devtools.toolbox.t_devtools$toolbox49549.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox49549.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox49549";

devtools.toolbox.t_devtools$toolbox49549.cljs$lang$ctorPrWriter = (function (this__25652__auto__,writer__25653__auto__,opt__25654__auto__){
return cljs.core._write.call(null,writer__25653__auto__,"devtools.toolbox/t_devtools$toolbox49549");
});

devtools.toolbox.__GT_t_devtools$toolbox49549 = (function devtools$toolbox$__GT_t_devtools$toolbox49549(obj__$1,header__$1,style__$1,tag__$1,meta49550){
return (new devtools.toolbox.t_devtools$toolbox49549(obj__$1,header__$1,style__$1,tag__$1,meta49550));
});

}

return (new devtools.toolbox.t_devtools$toolbox49549(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1484163027997