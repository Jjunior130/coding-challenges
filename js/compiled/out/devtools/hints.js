...
var line = cljs.core.get.call(null,map__39181__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__39181__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e39180){var _e = e39180;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___39183 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39183)){
var seen_errors_39184 = temp__4655__auto___39183;
if(cljs.core.truth_(seen_errors_39184.has(self))){
} else {
seen_errors_39184.add(self);

var temp__4657__auto___39185 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39185)){
var sense_39186 = temp__4657__auto___39185;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_39186)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484441682885