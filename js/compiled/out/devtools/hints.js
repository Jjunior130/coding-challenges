...
var line = cljs.core.get.call(null,map__28959__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28959__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e28958){var _e = e28958;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___28961 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___28961)){
var seen_errors_28962 = temp__4655__auto___28961;
if(cljs.core.truth_(seen_errors_28962.has(self))){
} else {
seen_errors_28962.add(self);

var temp__4657__auto___28963 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___28963)){
var sense_28964 = temp__4657__auto___28963;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_28964)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484456866378