...
}catch (e39088){var _e = e39088;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___39091 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___39091)){
var seen_errors_39092 = temp__4655__auto___39091;
if(cljs.core.truth_(seen_errors_39092.has(self))){
} else {
seen_errors_39092.add(self);

var temp__4657__auto___39093 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___39093)){
var sense_39094 = temp__4657__auto___39093;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_39094)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484163026289