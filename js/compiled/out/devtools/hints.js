...
var map__69330 = top_item;
var map__69330__$1 = ((((!((map__69330 == null)))?((((map__69330.cljs$lang$protocol_mask$partition0$ & (64))) || (map__69330.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__69330):map__69330);
var file = cljs.core.get.call(null,map__69330__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__69330__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__69330__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e69329){var _e = e69329;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___69332 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___69332)){
var seen_errors_69333 = temp__4655__auto___69332;
if(cljs.core.truth_(seen_errors_69333.has(self))){
} else {
seen_errors_69333.add(self);

var temp__4657__auto___69334 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___69334)){
var sense_69335 = temp__4657__auto___69334;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_69335)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484333417818