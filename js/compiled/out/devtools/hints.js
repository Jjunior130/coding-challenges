...
}catch (e36606){var _e = e36606;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___36609 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___36609)){
var seen_errors_36610 = temp__4655__auto___36609;
if(cljs.core.truth_(seen_errors_36610.has(self))){
} else {
seen_errors_36610.add(self);

var temp__4657__auto___36611 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___36611)){
var sense_36612 = temp__4657__auto___36611;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_36612)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1484702601278