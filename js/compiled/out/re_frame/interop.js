...
return [cljs.core.str((function (){var pred__49649 = cljs.core.instance_QMARK_;
var expr__49650 = reactive_val;
if(cljs.core.truth_(pred__49649.call(null,reagent.ratom.RAtom,expr__49650))){
return "ra";
} else {
if(cljs.core.truth_(pred__49649.call(null,reagent.ratom.RCursor,expr__49650))){
return "rc";
} else {
if(cljs.core.truth_(pred__49649.call(null,reagent.ratom.Reaction,expr__49650))){
return "rx";
} else {
if(cljs.core.truth_(pred__49649.call(null,reagent.ratom.Track,expr__49650))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1484333376230