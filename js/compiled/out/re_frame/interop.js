...
return [cljs.core.str((function (){var pred__8253 = cljs.core.instance_QMARK_;
var expr__8254 = reactive_val;
if(cljs.core.truth_(pred__8253.call(null,reagent.ratom.RAtom,expr__8254))){
return "ra";
} else {
if(cljs.core.truth_(pred__8253.call(null,reagent.ratom.RCursor,expr__8254))){
return "rc";
} else {
if(cljs.core.truth_(pred__8253.call(null,reagent.ratom.Reaction,expr__8254))){
return "rx";
} else {
if(cljs.core.truth_(pred__8253.call(null,reagent.ratom.Track,expr__8254))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1484456779463