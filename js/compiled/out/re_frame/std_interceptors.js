...
var vec__13736_13739 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_13740 = cljs.core.nth.call(null,vec__13736_13739,(0),null);
var only_after_13741 = cljs.core.nth.call(null,vec__13736_13739,(1),null);
var db_changed_QMARK__13742 = (cljs.core.some_QMARK_.call(null,only_before_13740)) || (cljs.core.some_QMARK_.call(null,only_after_13741));
if(db_changed_QMARK__13742){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_13740);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_13741);
...
var map__13749 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__13749__$1 = ((((!((map__13749 == null)))?((((map__13749.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13749.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13749):map__13749);
...
var map__13757 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__13757__$1;
var event = cljs.core.get.call(null,map__13757__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7484__auto___13760 = arguments.length;
var i__7485__auto___13761 = (0);
while(true){
if((i__7485__auto___13761 < len__7484__auto___13760)){
args__7491__auto__.push((arguments[i__7485__auto___13761]));

var G__13762 = (i__7485__auto___13761 + (1));
i__7485__auto___13761 = G__13762;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7492__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq13759){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13759));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__6409__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__7491__auto__ = [];
var len__7484__auto___13768 = arguments.length;
var i__7485__auto___13769 = (0);
while(true){
if((i__7485__auto___13769 < len__7484__auto___13768)){
args__7491__auto__.push((arguments[i__7485__auto___13769]));

var G__13770 = (i__7485__auto___13769 + (1));
i__7485__auto___13769 = G__13770;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7492__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__13763_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__13764_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__13764_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq13765){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__13766,G__13767,seq13765__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1484366700349