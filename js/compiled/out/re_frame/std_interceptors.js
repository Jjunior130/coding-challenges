...
var vec__131813_131816 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_131817 = cljs.core.nth.call(null,vec__131813_131816,(0),null);
var only_after_131818 = cljs.core.nth.call(null,vec__131813_131816,(1),null);
var db_changed_QMARK__131819 = (cljs.core.some_QMARK_.call(null,only_before_131817)) || (cljs.core.some_QMARK_.call(null,only_after_131818));
if(db_changed_QMARK__131819){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_131817);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_131818);
...
var map__131826 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__131826__$1 = ((((!((map__131826 == null)))?((((map__131826.cljs$lang$protocol_mask$partition0$ & (64))) || (map__131826.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__131826):map__131826);
var db = cljs.core.get.call(null,map__131826__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__131826__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__131834 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__131834__$1 = ((((!((map__131834 == null)))?((((map__131834.cljs$lang$protocol_mask$partition0$ & (64))) || (map__131834.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__131834):map__131834);
var coeffects = map__131834__$1;
var event = cljs.core.get.call(null,map__131834__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26121__auto___131837 = arguments.length;
var i__26122__auto___131838 = (0);
while(true){
if((i__26122__auto___131838 < len__26121__auto___131837)){
args__26128__auto__.push((arguments[i__26122__auto___131838]));

var G__131839 = (i__26122__auto___131838 + (1));
i__26122__auto___131838 = G__131839;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__26129__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq131836){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq131836));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__25046__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__26128__auto__ = [];
var len__26121__auto___131845 = arguments.length;
var i__26122__auto___131846 = (0);
while(true){
if((i__26122__auto___131846 < len__26121__auto___131845)){
args__26128__auto__.push((arguments[i__26122__auto___131846]));

var G__131847 = (i__26122__auto___131846 + (1));
i__26122__auto___131846 = G__131847;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26129__auto__);
});
...
return (function (p1__131840_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__131840_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__131841_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__131841_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq131842){
var G__131843 = cljs.core.first.call(null,seq131842);
var seq131842__$1 = cljs.core.next.call(null,seq131842);
var G__131844 = cljs.core.first.call(null,seq131842__$1);
var seq131842__$2 = cljs.core.next.call(null,seq131842__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__131843,G__131844,seq131842__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1484099804704