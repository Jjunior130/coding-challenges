...
var vec__13746_13749 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_13750 = cljs.core.nth.call(null,vec__13746_13749,(0),null);
var only_after_13751 = cljs.core.nth.call(null,vec__13746_13749,(1),null);
var db_changed_QMARK__13752 = (cljs.core.some_QMARK_.call(null,only_before_13750)) || (cljs.core.some_QMARK_.call(null,only_after_13751));
if(db_changed_QMARK__13752){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_13750);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_13751);
...
var map__13759 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__13759__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__13759__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__13767 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__13767__$1 = ((((!((map__13767 == null)))?((((map__13767.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13767.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13767):map__13767);
var coeffects = map__13767__$1;
var event = cljs.core.get.call(null,map__13767__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7494__auto___13770 = arguments.length;
var i__7495__auto___13771 = (0);
while(true){
if((i__7495__auto___13771 < len__7494__auto___13770)){
args__7501__auto__.push((arguments[i__7495__auto___13771]));

var G__13772 = (i__7495__auto___13771 + (1));
i__7495__auto___13771 = G__13772;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7502__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq13769){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13769));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__6419__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__7501__auto__ = [];
var len__7494__auto___13778 = arguments.length;
var i__7495__auto___13779 = (0);
while(true){
if((i__7495__auto___13779 < len__7494__auto___13778)){
args__7501__auto__.push((arguments[i__7495__auto___13779]));

var G__13780 = (i__7495__auto___13779 + (1));
i__7495__auto___13779 = G__13780;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7502__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__13773_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__13774_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__13774_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq13775){
var G__13776 = cljs.core.first.call(null,seq13775);
var seq13775__$1 = cljs.core.next.call(null,seq13775);
var G__13777 = cljs.core.first.call(null,seq13775__$1);
var seq13775__$2 = cljs.core.next.call(null,seq13775__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__13776,G__13777,seq13775__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1484456793863