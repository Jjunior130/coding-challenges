...
var vec__52337_52340 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_52341 = cljs.core.nth.call(null,vec__52337_52340,(0),null);
var only_after_52342 = cljs.core.nth.call(null,vec__52337_52340,(1),null);
var db_changed_QMARK__52343 = (cljs.core.some_QMARK_.call(null,only_before_52341)) || (cljs.core.some_QMARK_.call(null,only_after_52342));
if(db_changed_QMARK__52343){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_52341);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_52342);
...
var map__52350 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__52350__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__52350__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__52358 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__52358__$1 = ((((!((map__52358 == null)))?((((map__52358.cljs$lang$protocol_mask$partition0$ & (64))) || (map__52358.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52358):map__52358);
var coeffects = map__52358__$1;
var event = cljs.core.get.call(null,map__52358__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26121__auto___52361 = arguments.length;
var i__26122__auto___52362 = (0);
while(true){
if((i__26122__auto___52362 < len__26121__auto___52361)){
args__26128__auto__.push((arguments[i__26122__auto___52362]));

var G__52363 = (i__26122__auto___52362 + (1));
i__26122__auto___52362 = G__52363;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq52360){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq52360));
});
...
var args__26128__auto__ = [];
var len__26121__auto___52369 = arguments.length;
var i__26122__auto___52370 = (0);
while(true){
if((i__26122__auto___52370 < len__26121__auto___52369)){
args__26128__auto__.push((arguments[i__26122__auto___52370]));

var G__52371 = (i__26122__auto___52370 + (1));
i__26122__auto___52370 = G__52371;
continue;
} else {
}
break;
...
return (function (p1__52364_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__52364_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__52365_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__52365_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq52366){
var G__52367 = cljs.core.first.call(null,seq52366);
var seq52366__$1 = cljs.core.next.call(null,seq52366);
var G__52368 = cljs.core.first.call(null,seq52366__$1);
var seq52366__$2 = cljs.core.next.call(null,seq52366__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__52367,G__52368,seq52366__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1484333382767