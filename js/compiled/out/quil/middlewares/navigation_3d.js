...
var vec__140934 = axis;
var a_x = cljs.core.nth.call(null,vec__140934,(0),null);
var a_y = cljs.core.nth.call(null,vec__140934,(1),null);
var a_z = cljs.core.nth.call(null,vec__140934,(2),null);
var vec__140937 = v;
var x = cljs.core.nth.call(null,vec__140937,(0),null);
var y = cljs.core.nth.call(null,vec__140937,(1),null);
var z = cljs.core.nth.call(null,vec__140937,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__140940,p__140941){
var vec__140948 = p__140940;
var u1 = cljs.core.nth.call(null,vec__140948,(0),null);
var u2 = cljs.core.nth.call(null,vec__140948,(1),null);
var u3 = cljs.core.nth.call(null,vec__140948,(2),null);
var vec__140951 = p__140941;
var v1 = cljs.core.nth.call(null,vec__140951,(0),null);
var v2 = cljs.core.nth.call(null,vec__140951,(1),null);
var v3 = cljs.core.nth.call(null,vec__140951,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__140954_SHARP_){
return (p1__140954_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__140955_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__140955_SHARP_,axis,angle);
});})(axis))
;
...
return (function (p1__140956_SHARP_){
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__140956_SHARP_,angle_lr),angle_ud);
...
var map__140963 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__140963__$1 = ((((!((map__140963 == null)))?((((map__140963.cljs$lang$protocol_mask$partition0$ & (64))) || (map__140963.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__140963):map__140963);
var up = cljs.core.get.call(null,map__140963__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__140963__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__140965 = cljs.core._EQ_;
var expr__140966 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__140965.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__140966))){
return straight;
} else {
if(cljs.core.truth_(pred__140965.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__140966))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__140965.call(null,quil.middlewares.navigation_3d.space,expr__140966))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__140965.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__140966))){
return up;
} else {
if(cljs.core.truth_(pred__140965.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__140966))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__140965.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__140966))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__140963,map__140963__$1,up,straight){
return (function (p1__140957_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__140957_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__140963,map__140963__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__140968_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__140968_SHARP_);
});})(initial_state))
);
});
/**
...
var map__140980_140991 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__140980_140992__$1 = ((((!((map__140980_140991 == null)))?((((map__140980_140991.cljs$lang$protocol_mask$partition0$ & (64))) || (map__140980_140991.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__140980_140991):map__140980_140991);
var vec__140981_140993 = cljs.core.get.call(null,map__140980_140992__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_140994 = cljs.core.nth.call(null,vec__140981_140993,(0),null);
var c_y_140995 = cljs.core.nth.call(null,vec__140981_140993,(1),null);
var c_z_140996 = cljs.core.nth.call(null,vec__140981_140993,(2),null);
var vec__140984_140997 = cljs.core.get.call(null,map__140980_140992__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_140998 = cljs.core.nth.call(null,vec__140984_140997,(0),null);
var u_y_140999 = cljs.core.nth.call(null,vec__140984_140997,(1),null);
var u_z_141000 = cljs.core.nth.call(null,vec__140984_140997,(2),null);
var vec__140987_141001 = cljs.core.get.call(null,map__140980_140992__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_141002 = cljs.core.nth.call(null,vec__140987_141001,(0),null);
var p_y_141003 = cljs.core.nth.call(null,vec__140987_141001,(1),null);
var p_z_141004 = cljs.core.nth.call(null,vec__140987_141001,(2),null);
quil.core.camera.call(null,p_x_141002,p_y_141003,p_z_141004,(p_x_141002 + c_x_140994),(p_y_141003 + c_y_140995),(p_z_141004 + c_z_140996),u_x_140998,u_y_140999,u_z_141000);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1484099822552