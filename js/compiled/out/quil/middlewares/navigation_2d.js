...
return cljs.core.merge.call(null,initial_state,p1__34793_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_34794 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_34795 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_34794);
var pos_34796 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_34794);
quil.core.scale.call(null,zoom_34795);

var tr__15941__auto___34797 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_34795) - cljs.core.first.call(null,pos_34796)),(((quil.core.height.call(null) / (2)) / zoom_34795) - cljs.core.second.call(null,pos_34796))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__15941__auto___34797);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1484456850436