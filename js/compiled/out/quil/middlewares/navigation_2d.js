...
return cljs.core.merge.call(null,initial_state,p1__32208_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_32209 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_32210 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_32209);
var pos_32211 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_32209);
quil.core.scale.call(null,zoom_32210);

var tr__13880__auto___32212 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_32210) - cljs.core.first.call(null,pos_32211)),(((quil.core.height.call(null) / (2)) / zoom_32210) - cljs.core.second.call(null,pos_32211))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__13880__auto___32212);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1484702588227