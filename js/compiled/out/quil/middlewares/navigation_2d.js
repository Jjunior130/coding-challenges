...
return (function (p1__141007_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__141007_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_141008 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_141009 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_141008);
var pos_141010 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_141008);
quil.core.scale.call(null,zoom_141009);

var tr__43172__auto___141011 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_141009) - cljs.core.first.call(null,pos_141010)),(((quil.core.height.call(null) / (2)) / zoom_141009) - cljs.core.second.call(null,pos_141010))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__43172__auto___141011);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1484099822613