...
var args136811 = [];
var len__26121__auto___136815 = arguments.length;
var i__26122__auto___136816 = (0);
while(true){
if((i__26122__auto___136816 < len__26121__auto___136815)){
args136811.push((arguments[i__26122__auto___136816]));

var G__136817 = (i__26122__auto___136816 + (1));
i__26122__auto___136816 = G__136817;
continue;
} else {
}
break;
...
var G__136813 = args136811.length;
switch (G__136813) {
case 2:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args136811.length)].join('')));
...
var G__136819 = (function (){var G__136814 = sb;
G__136814.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__136814;
})();
var G__136820 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__136819;
ch = G__136820;
continue;
}
...
var temp__4655__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__136822 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__136822,ch);
...
var args136823 = [];
var len__26121__auto___136826 = arguments.length;
var i__26122__auto___136827 = (0);
while(true){
if((i__26122__auto___136827 < len__26121__auto___136826)){
args136823.push((arguments[i__26122__auto___136827]));

var G__136828 = (i__26122__auto___136827 + (1));
i__26122__auto___136827 = G__136828;
continue;
} else {
}
break;
...
var G__136825 = args136823.length;
switch (G__136825) {
case 4:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args136823.length)].join('')));
...
var G__136836 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__136836;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__136835 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__136835,ch);

return G__136835;
})(),true,null,opts);
var G__136837 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__136837;
continue;
}
}
...
var sb = (function (){var G__136840 = (new goog.string.StringBuffer());
G__136840.append(initch);
...
var G__136842 = (function (){var G__136841 = sb;
G__136841.append(ch);

return G__136841;
})();
var G__136843 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__136842;
ch = G__136843;
continue;
}
...
while(true){
var G__136850 = ch;
if(cljs.core._EQ_.call(null,null,G__136850)){
return cljs.tools.reader.reader_types.reader_error.call(null,reader,"EOF while reading string");
} else {
if(cljs.core._EQ_.call(null,"\\",G__136850)){
var G__136853 = (function (){var G__136851 = sb;
G__136851.append(cljs.tools.reader.edn.escape_char.call(null,sb,reader));

return G__136851;
})();
var G__136854 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__136853;
ch = G__136854;
continue;
} else {
...
var G__136855 = (function (){var G__136852 = sb;
G__136852.append(ch);

return G__136852;
})();
var G__136856 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__136855;
ch = G__136856;
continue;
...
var G__136863 = rdr;
cljs.tools.reader.edn.read.call(null,G__136863,true,null,true);
...
var temp__4655__auto__ = (function (){var G__136865 = token;
var G__136865__$1 = (((G__136865 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__136865));
if((G__136865__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__136865__$1);
}
})();
if(cljs.core.truth_(temp__4655__auto__)){
...
var args136872 = [];
var len__26121__auto___136879 = arguments.length;
var i__26122__auto___136880 = (0);
while(true){
if((i__26122__auto___136880 < len__26121__auto___136879)){
args136872.push((arguments[i__26122__auto___136880]));

var G__136881 = (i__26122__auto___136880 + (1));
i__26122__auto___136880 = G__136881;
continue;
} else {
}
break;
...
var G__136874 = args136872.length;
switch (G__136874) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args136872.length)].join('')));
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__136875,reader){
var map__136876 = p__136875;
var map__136876__$1 = ((((!((map__136876 == null)))?((((map__136876.cljs$lang$protocol_mask$partition0$ & (64))) || (map__136876.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__136876):map__136876);
var opts = map__136876__$1;
var eof = cljs.core.get.call(null,map__136876__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
}catch (e136878){if((e136878 instanceof Error)){
var e = e136878;
...
var args136883 = [];
var len__26121__auto___136886 = arguments.length;
var i__26122__auto___136887 = (0);
while(true){
if((i__26122__auto___136887 < len__26121__auto___136886)){
args136883.push((arguments[i__26122__auto___136887]));

var G__136888 = (i__26122__auto___136887 + (1));
i__26122__auto___136887 = G__136888;
continue;
} else {
}
break;
...
var G__136885 = args136883.length;
switch (G__136885) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args136883.length)].join('')));
...
//# sourceMappingURL=edn.js.map?rel=1484099811614