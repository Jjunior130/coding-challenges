...
var args57480 = [];
var len__26121__auto___57484 = arguments.length;
var i__26122__auto___57485 = (0);
while(true){
if((i__26122__auto___57485 < len__26121__auto___57484)){
args57480.push((arguments[i__26122__auto___57485]));

var G__57486 = (i__26122__auto___57485 + (1));
i__26122__auto___57485 = G__57486;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57480.length)].join('')));
...
var G__57483 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__57483,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__57483;
}
});
...
var len__26121__auto___57491 = arguments.length;
var i__26122__auto___57492 = (0);
while(true){
if((i__26122__auto___57492 < len__26121__auto___57491)){
args__26128__auto__.push((arguments[i__26122__auto___57492]));

var G__57493 = (i__26122__auto___57492 + (1));
i__26122__auto___57492 = G__57493;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq57488){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__57489,G__57490,seq57488__$2);
});
...
var map__57497 = m;
var map__57497__$1 = ((((!((map__57497 == null)))?((((map__57497.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57497.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57497):map__57497);
var file = cljs.core.get.call(null,map__57497__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__57497__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__57497__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__57497,map__57497__$1,file,line,column){
return (function (p1__57494_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__57494_SHARP_));
});})(map__57497,map__57497__$1,file,line,column))
...
var temp__4657__auto___57499 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___57499)){
var message_57500 = temp__4657__auto___57499;
cljs.core.println.call(null,message_57500);
} else {
}
...
var temp__4657__auto___57501 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___57501)){
var message_57502 = temp__4657__auto___57501;
cljs.core.println.call(null,message_57502);
} else {
}
...
var G__57512 = exception.stack;
var G__57512__$1 = (((G__57512 == null))?null:clojure.string.split_lines.call(null,G__57512));
var G__57512__$2 = (((G__57512__$1 == null))?null:cljs.core.get.call(null,G__57512__$1,depth));
if((G__57512__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__57512__$2);
}
} else {
...
var vec__57513 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__57513,(0),null);
var column = cljs.core.nth.call(null,vec__57513,(1),null);
var vec__57516 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__57516,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__57516,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__57516,(2),null);
...
var m__$1 = (function (){var G__57520 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__57520) {
case "fail":
...
var G__57526 = (function (){var G__57525 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__57525);
} else {
return G__57525;
}
})();
...
return cljs.core.vary_meta.call(null,G__57528,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e57531){var e = e57531;
var G__57532 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__57532) {
...
var vec__57537 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__57537,(0),null);
var types = vec__57537;
...
return cljs.core.map.call(null,(function (p__57549){
var vec__57550 = p__57549;
var ns = cljs.core.nth.call(null,vec__57550,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__57550,(1),null);
return ((function (vec__57550,ns,vars__$1){
return (function (){
...
var G__57553 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__57553) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1){
return (function (){
var seq__57554 = cljs.core.seq.call(null,vars__$1);
var chunk__57555 = null;
var count__57556 = (0);
var i__57557 = (0);
while(true){
if((i__57557 < count__57556)){
var v = cljs.core._nth.call(null,chunk__57555,i__57557);
var temp__4657__auto___57559 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___57559)){
var t_57560 = temp__4657__auto___57559;
each_fixture_fn.call(null,((function (seq__57554,chunk__57555,count__57556,i__57557,t_57560,temp__4657__auto___57559,v,each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_57560)));
});})(seq__57554,chunk__57555,count__57556,i__57557,t_57560,temp__4657__auto___57559,v,each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1))
);
} else {
}

var G__57561 = seq__57554;
var G__57562 = chunk__57555;
var G__57563 = count__57556;
var G__57564 = (i__57557 + (1));
seq__57554 = G__57561;
chunk__57555 = G__57562;
count__57556 = G__57563;
i__57557 = G__57564;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__57554);
if(temp__4657__auto__){
var seq__57554__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__57554__$1)){
var c__25857__auto__ = cljs.core.chunk_first.call(null,seq__57554__$1);
var G__57565 = cljs.core.chunk_rest.call(null,seq__57554__$1);
var G__57566 = c__25857__auto__;
var G__57567 = cljs.core.count.call(null,c__25857__auto__);
var G__57568 = (0);
seq__57554 = G__57565;
chunk__57555 = G__57566;
count__57556 = G__57567;
i__57557 = G__57568;
continue;
} else {
var v = cljs.core.first.call(null,seq__57554__$1);
var temp__4657__auto___57569__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___57569__$1)){
var t_57570 = temp__4657__auto___57569__$1;
each_fixture_fn.call(null,((function (seq__57554,chunk__57555,count__57556,i__57557,t_57570,temp__4657__auto___57569__$1,v,seq__57554__$1,temp__4657__auto__,each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_57570)));
});})(seq__57554,chunk__57555,count__57556,i__57557,t_57570,temp__4657__auto___57569__$1,v,seq__57554__$1,temp__4657__auto__,each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1))
);
} else {
}

var G__57571 = cljs.core.next.call(null,seq__57554__$1);
var G__57572 = null;
var G__57573 = (0);
var G__57574 = (0);
seq__57554 = G__57571;
chunk__57555 = G__57572;
count__57556 = G__57573;
i__57557 = G__57574;
continue;
}
} else {
...
});})(each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1))
);
});})(each_fixture_fn,G__57553,env,once_fixtures,each_fixtures,vec__57550,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1484333390855