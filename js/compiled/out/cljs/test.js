...
var args21019 = [];
var len__7494__auto___21023 = arguments.length;
var i__7495__auto___21024 = (0);
while(true){
if((i__7495__auto___21024 < len__7494__auto___21023)){
args21019.push((arguments[i__7495__auto___21024]));

var G__21025 = (i__7495__auto___21024 + (1));
i__7495__auto___21024 = G__21025;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args21019.length)].join('')));
...
var G__21022 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21022,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21022;
}
});
...
var or__6419__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__7494__auto___21030 = arguments.length;
var i__7495__auto___21031 = (0);
while(true){
if((i__7495__auto___21031 < len__7494__auto___21030)){
args__7501__auto__.push((arguments[i__7495__auto___21031]));

var G__21032 = (i__7495__auto___21031 + (1));
i__7495__auto___21031 = G__21032;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7502__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21027){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__21028,G__21029,seq21027__$2);
});
...
var file = cljs.core.get.call(null,map__21036__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21036__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21036__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21036,map__21036__$1,file,line,column){
return (function (p1__21033_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21033_SHARP_));
});})(map__21036,map__21036__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__7344__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__7344__auto__,prefer_table__7345__auto__,method_cache__7346__auto__,cached_hierarchy__7347__auto__,hierarchy__7348__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6419__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6419__auto__)){
return or__6419__auto__;
} else {
...
var temp__4657__auto___21038 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___21038)){
var message_21039 = temp__4657__auto___21038;
cljs.core.println.call(null,message_21039);
} else {
}
...
var temp__4657__auto___21040 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___21040)){
var message_21041 = temp__4657__auto___21040;
cljs.core.println.call(null,message_21041);
} else {
}
...
var temp__4655__auto__ = (function (){var and__6407__auto__ = typeof exception.stack === 'string';
if(and__6407__auto__){
var G__21051 = exception.stack;
var G__21051__$1 = (((G__21051 == null))?null:clojure.string.split_lines.call(null,G__21051));
var G__21051__$2 = (((G__21051__$1 == null))?null:cljs.core.get.call(null,G__21051__$1,depth));
if((G__21051__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21051__$2);
}
} else {
...
var vec__21052 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21052,(0),null);
var column = cljs.core.nth.call(null,vec__21052,(1),null);
var vec__21055 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21055,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21055,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21055,(2),null);
...
var m__$1 = (function (){var G__21059 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__21059) {
case "fail":
...
var G__21065 = (function (){var G__21064 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21064);
} else {
return G__21064;
}
})();
...
return cljs.core.vary_meta.call(null,G__21067,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e21070){var e = e21070;
var G__21071 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__21071) {
...
var vec__21076 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21076,(0),null);
var types = vec__21076;
...
return cljs.core.map.call(null,(function (p__21088){
var vec__21089 = p__21088;
var ns = cljs.core.nth.call(null,vec__21089,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21089,(1),null);
return ((function (vec__21089,ns,vars__$1){
return (function (){
...
var G__21092 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__21092) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1){
return (function (){
var seq__21093 = cljs.core.seq.call(null,vars__$1);
var chunk__21094 = null;
var count__21095 = (0);
var i__21096 = (0);
while(true){
if((i__21096 < count__21095)){
var v = cljs.core._nth.call(null,chunk__21094,i__21096);
var temp__4657__auto___21098 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___21098)){
var t_21099 = temp__4657__auto___21098;
each_fixture_fn.call(null,((function (seq__21093,chunk__21094,count__21095,i__21096,t_21099,temp__4657__auto___21098,v,each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21099)));
});})(seq__21093,chunk__21094,count__21095,i__21096,t_21099,temp__4657__auto___21098,v,each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1))
);
} else {
}

var G__21100 = seq__21093;
var G__21101 = chunk__21094;
var G__21102 = count__21095;
var G__21103 = (i__21096 + (1));
seq__21093 = G__21100;
chunk__21094 = G__21101;
count__21095 = G__21102;
i__21096 = G__21103;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__21093);
if(temp__4657__auto__){
var seq__21093__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21093__$1)){
var c__7230__auto__ = cljs.core.chunk_first.call(null,seq__21093__$1);
var G__21104 = cljs.core.chunk_rest.call(null,seq__21093__$1);
var G__21105 = c__7230__auto__;
var G__21106 = cljs.core.count.call(null,c__7230__auto__);
var G__21107 = (0);
seq__21093 = G__21104;
chunk__21094 = G__21105;
count__21095 = G__21106;
i__21096 = G__21107;
continue;
} else {
var v = cljs.core.first.call(null,seq__21093__$1);
var temp__4657__auto___21108__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___21108__$1)){
var t_21109 = temp__4657__auto___21108__$1;
each_fixture_fn.call(null,((function (seq__21093,chunk__21094,count__21095,i__21096,t_21109,temp__4657__auto___21108__$1,v,seq__21093__$1,temp__4657__auto__,each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21109)));
});})(seq__21093,chunk__21094,count__21095,i__21096,t_21109,temp__4657__auto___21108__$1,v,seq__21093__$1,temp__4657__auto__,each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1))
);
} else {
}

var G__21110 = cljs.core.next.call(null,seq__21093__$1);
var G__21111 = null;
var G__21112 = (0);
var G__21113 = (0);
seq__21093 = G__21110;
chunk__21094 = G__21111;
count__21095 = G__21112;
i__21096 = G__21113;
continue;
}
} else {
...
});})(each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1))
);
});})(each_fixture_fn,G__21092,env,once_fixtures,each_fixtures,vec__21089,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1484456820115