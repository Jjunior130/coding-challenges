...
var args34981 = [];
var len__26121__auto___34985 = arguments.length;
var i__26122__auto___34986 = (0);
while(true){
if((i__26122__auto___34986 < len__26121__auto___34985)){
args34981.push((arguments[i__26122__auto___34986]));

var G__34987 = (i__26122__auto___34986 + (1));
i__26122__auto___34986 = G__34987;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34981.length)].join('')));
...
var G__34984 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__34984,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__34984;
}
});
...
var len__26121__auto___34992 = arguments.length;
var i__26122__auto___34993 = (0);
while(true){
if((i__26122__auto___34993 < len__26121__auto___34992)){
args__26128__auto__.push((arguments[i__26122__auto___34993]));

var G__34994 = (i__26122__auto___34993 + (1));
i__26122__auto___34993 = G__34994;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq34989){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__34990,G__34991,seq34989__$2);
});
...
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__34998,map__34998__$1,file,line,column){
return (function (p1__34995_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__34995_SHARP_));
});})(map__34998,map__34998__$1,file,line,column))
...
var temp__4657__auto___35000 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35000)){
var message_35001 = temp__4657__auto___35000;
cljs.core.println.call(null,message_35001);
} else {
}
...
var temp__4657__auto___35002 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___35002)){
var message_35003 = temp__4657__auto___35002;
cljs.core.println.call(null,message_35003);
} else {
}
...
var G__35013 = exception.stack;
var G__35013__$1 = (((G__35013 == null))?null:clojure.string.split_lines.call(null,G__35013));
var G__35013__$2 = (((G__35013__$1 == null))?null:cljs.core.get.call(null,G__35013__$1,depth));
if((G__35013__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__35013__$2);
}
} else {
...
var vec__35014 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__35014,(0),null);
var column = cljs.core.nth.call(null,vec__35014,(1),null);
var vec__35017 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__35017,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__35017,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__35017,(2),null);
...
var m__$1 = (function (){var G__35021 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__35021) {
case "fail":
...
var G__35027 = (function (){var G__35026 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__35026);
} else {
return G__35026;
}
})();
...
return cljs.core.vary_meta.call(null,G__35029,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e35032){var e = e35032;
var G__35033 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__35033) {
...
var vec__35038 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__35038,(0),null);
var types = vec__35038;
...
return cljs.core.map.call(null,(function (p__35050){
var vec__35051 = p__35050;
var ns = cljs.core.nth.call(null,vec__35051,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__35051,(1),null);
return ((function (vec__35051,ns,vars__$1){
return (function (){
...
var G__35054 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__35054) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1){
return (function (){
var seq__35055 = cljs.core.seq.call(null,vars__$1);
var chunk__35056 = null;
var count__35057 = (0);
var i__35058 = (0);
while(true){
if((i__35058 < count__35057)){
var v = cljs.core._nth.call(null,chunk__35056,i__35058);
var temp__4657__auto___35060 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35060)){
var t_35061 = temp__4657__auto___35060;
each_fixture_fn.call(null,((function (seq__35055,chunk__35056,count__35057,i__35058,t_35061,temp__4657__auto___35060,v,each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35061)));
});})(seq__35055,chunk__35056,count__35057,i__35058,t_35061,temp__4657__auto___35060,v,each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1))
);
} else {
}

var G__35062 = seq__35055;
var G__35063 = chunk__35056;
var G__35064 = count__35057;
var G__35065 = (i__35058 + (1));
seq__35055 = G__35062;
chunk__35056 = G__35063;
count__35057 = G__35064;
i__35058 = G__35065;
continue;
} else {
...
var c__25857__auto__ = cljs.core.chunk_first.call(null,seq__35055__$1);
var G__35066 = cljs.core.chunk_rest.call(null,seq__35055__$1);
var G__35067 = c__25857__auto__;
var G__35068 = cljs.core.count.call(null,c__25857__auto__);
var G__35069 = (0);
seq__35055 = G__35066;
chunk__35056 = G__35067;
count__35057 = G__35068;
i__35058 = G__35069;
continue;
} else {
var v = cljs.core.first.call(null,seq__35055__$1);
var temp__4657__auto___35070__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___35070__$1)){
var t_35071 = temp__4657__auto___35070__$1;
each_fixture_fn.call(null,((function (seq__35055,chunk__35056,count__35057,i__35058,t_35071,temp__4657__auto___35070__$1,v,seq__35055__$1,temp__4657__auto__,each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_35071)));
});})(seq__35055,chunk__35056,count__35057,i__35058,t_35071,temp__4657__auto___35070__$1,v,seq__35055__$1,temp__4657__auto__,each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1))
);
} else {
}

var G__35072 = cljs.core.next.call(null,seq__35055__$1);
var G__35073 = null;
var G__35074 = (0);
var G__35075 = (0);
seq__35055 = G__35072;
chunk__35056 = G__35073;
count__35057 = G__35074;
i__35058 = G__35075;
continue;
}
} else {
...
});})(each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1))
);
});})(each_fixture_fn,G__35054,env,once_fixtures,each_fixtures,vec__35051,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1484163001436