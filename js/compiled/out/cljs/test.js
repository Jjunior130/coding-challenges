...
var args21009 = [];
var len__7484__auto___21013 = arguments.length;
var i__7485__auto___21014 = (0);
while(true){
if((i__7485__auto___21014 < len__7484__auto___21013)){
args21009.push((arguments[i__7485__auto___21014]));

var G__21015 = (i__7485__auto___21014 + (1));
i__7485__auto___21014 = G__21015;
continue;
} else {
}
break;
...
var G__21012 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21012,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21012;
}
});
...
var len__7484__auto___21020 = arguments.length;
var i__7485__auto___21021 = (0);
while(true){
if((i__7485__auto___21021 < len__7484__auto___21020)){
args__7491__auto__.push((arguments[i__7485__auto___21021]));

var G__21022 = (i__7485__auto___21021 + (1));
i__7485__auto___21021 = G__21022;
continue;
} else {
}
break;
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21017){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__21018,G__21019,seq21017__$2);
});
...
var map__21026 = m;
var map__21026__$1 = ((((!((map__21026 == null)))?((((map__21026.cljs$lang$protocol_mask$partition0$ & (64))) || (map__21026.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21026):map__21026);
var file = cljs.core.get.call(null,map__21026__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21026__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21026__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21026,map__21026__$1,file,line,column){
return (function (p1__21023_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21023_SHARP_));
});})(map__21026,map__21026__$1,file,line,column))
...
var temp__4657__auto___21028 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___21028)){
var message_21029 = temp__4657__auto___21028;
cljs.core.println.call(null,message_21029);
} else {
}
...
var temp__4657__auto___21030 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___21030)){
var message_21031 = temp__4657__auto___21030;
cljs.core.println.call(null,message_21031);
} else {
}
...
var G__21041 = exception.stack;
var G__21041__$1 = (((G__21041 == null))?null:clojure.string.split_lines.call(null,G__21041));
var G__21041__$2 = (((G__21041__$1 == null))?null:cljs.core.get.call(null,G__21041__$1,depth));
if((G__21041__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21041__$2);
}
} else {
...
var vec__21042 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21042,(0),null);
var column = cljs.core.nth.call(null,vec__21042,(1),null);
var vec__21045 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21045,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21045,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21045,(2),null);
...
var m__$1 = (function (){var G__21049 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__21049) {
case "fail":
...
var G__21055 = (function (){var G__21054 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21054);
} else {
return G__21054;
}
})();
...
return cljs.core.vary_meta.call(null,G__21057,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e21060){var e = e21060;
var G__21061 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__21061) {
...
var vec__21066 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21066,(0),null);
var types = vec__21066;
...
return cljs.core.map.call(null,(function (p__21078){
var vec__21079 = p__21078;
var ns = cljs.core.nth.call(null,vec__21079,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21079,(1),null);
return ((function (vec__21079,ns,vars__$1){
return (function (){
...
var G__21082 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__21082) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1){
return (function (){
var seq__21083 = cljs.core.seq.call(null,vars__$1);
var chunk__21084 = null;
var count__21085 = (0);
var i__21086 = (0);
while(true){
if((i__21086 < count__21085)){
var v = cljs.core._nth.call(null,chunk__21084,i__21086);
var temp__4657__auto___21088 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___21088)){
var t_21089 = temp__4657__auto___21088;
each_fixture_fn.call(null,((function (seq__21083,chunk__21084,count__21085,i__21086,t_21089,temp__4657__auto___21088,v,each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21089)));
});})(seq__21083,chunk__21084,count__21085,i__21086,t_21089,temp__4657__auto___21088,v,each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1))
);
} else {
}

var G__21090 = seq__21083;
var G__21091 = chunk__21084;
var G__21092 = count__21085;
var G__21093 = (i__21086 + (1));
seq__21083 = G__21090;
chunk__21084 = G__21091;
count__21085 = G__21092;
i__21086 = G__21093;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__21083);
if(temp__4657__auto__){
var seq__21083__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21083__$1)){
var c__7220__auto__ = cljs.core.chunk_first.call(null,seq__21083__$1);
var G__21094 = cljs.core.chunk_rest.call(null,seq__21083__$1);
var G__21095 = c__7220__auto__;
var G__21096 = cljs.core.count.call(null,c__7220__auto__);
var G__21097 = (0);
seq__21083 = G__21094;
chunk__21084 = G__21095;
count__21085 = G__21096;
i__21086 = G__21097;
continue;
} else {
var v = cljs.core.first.call(null,seq__21083__$1);
var temp__4657__auto___21098__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___21098__$1)){
var t_21099 = temp__4657__auto___21098__$1;
each_fixture_fn.call(null,((function (seq__21083,chunk__21084,count__21085,i__21086,t_21099,temp__4657__auto___21098__$1,v,seq__21083__$1,temp__4657__auto__,each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1){
return (function (){
...
});})(seq__21083,chunk__21084,count__21085,i__21086,t_21099,temp__4657__auto___21098__$1,v,seq__21083__$1,temp__4657__auto__,each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1))
);
} else {
}

var G__21100 = cljs.core.next.call(null,seq__21083__$1);
var G__21101 = null;
var G__21102 = (0);
var G__21103 = (0);
seq__21083 = G__21100;
chunk__21084 = G__21101;
count__21085 = G__21102;
i__21086 = G__21103;
continue;
}
} else {
...
});})(each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1))
);
});})(each_fixture_fn,G__21082,env,once_fixtures,each_fixtures,vec__21079,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1484441660028