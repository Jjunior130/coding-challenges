...
var args61326 = [];
var len__26121__auto___61329 = arguments.length;
var i__26122__auto___61330 = (0);
while(true){
if((i__26122__auto___61330 < len__26121__auto___61329)){
args61326.push((arguments[i__26122__auto___61330]));

var G__61331 = (i__26122__auto___61330 + (1));
i__26122__auto___61330 = G__61331;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args61326.length)].join('')));
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__61336){
var map__61339 = p__61336;
var map__61339__$1 = ((((!((map__61339 == null)))?((((map__61339.cljs$lang$protocol_mask$partition0$ & (64))) || (map__61339.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61339):map__61339);
var args = map__61339__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__61339__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__61339,map__61339__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__61333_SHARP_){
return item_renderer.call(null,p1__61333_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__61339,map__61339__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__61339,map__61339__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__61334_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__61334_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__61339,map__61339__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__61339,map__61339__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__61335_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__61335_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__61339,map__61339__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__26121__auto___61348 = arguments.length;
var i__26122__auto___61349 = (0);
while(true){
if((i__26122__auto___61349 < len__26121__auto___61348)){
args__26128__auto__.push((arguments[i__26122__auto___61349]));

var G__61350 = (i__26122__auto___61349 + (1));
i__26122__auto___61349 = G__61350;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__61342){
...
var args = map__61343__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__61343,map__61343__$1,args){
return (function() { 
var G__61351__delegate = function (p__61345){
var map__61346 = p__61345;
var map__61346__$1 = ((((!((map__61346 == null)))?((((map__61346.cljs$lang$protocol_mask$partition0$ & (64))) || (map__61346.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61346):map__61346);
var args__$1 = map__61346__$1;
...
var G__61352__i = 0, G__61352__a = new Array(arguments.length -  0);
while (G__61352__i < G__61352__a.length) {G__61352__a[G__61352__i] = arguments[G__61352__i + 0]; ++G__61352__i;}
  p__61345 = new cljs.core.IndexedSeq(G__61352__a,0);
} 
return G__61351__delegate.call(this,p__61345);};
G__61351.cljs$lang$maxFixedArity = 0;
G__61351.cljs$lang$applyTo = (function (arglist__61353){
var p__61345 = cljs.core.seq(arglist__61353);
return G__61351__delegate(p__61345);
});
G__61351.cljs$core$IFn$_invoke$arity$variadic = G__61351__delegate;
return G__61351;
})()
;
;})(map__61343,map__61343__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq61341){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq61341));
});


//# sourceMappingURL=selection_list.js.map?rel=1484333400935