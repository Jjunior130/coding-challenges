...
var args34504 = [];
var len__7484__auto___34507 = arguments.length;
var i__7485__auto___34508 = (0);
while(true){
if((i__7485__auto___34508 < len__7484__auto___34507)){
args34504.push((arguments[i__7485__auto___34508]));

var G__34509 = (i__7485__auto___34508 + (1));
i__7485__auto___34508 = G__34509;
continue;
} else {
}
break;
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__34514){
var map__34517 = p__34514;
...
var args = map__34517__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__34517__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__34517,map__34517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34511_SHARP_){
return item_renderer.call(null,p1__34511_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34517,map__34517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__34517,map__34517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34512_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__34512_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34517,map__34517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__34517,map__34517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34513_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__34513_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34517,map__34517__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__7484__auto___34526 = arguments.length;
var i__7485__auto___34527 = (0);
while(true){
if((i__7485__auto___34527 < len__7484__auto___34526)){
args__7491__auto__.push((arguments[i__7485__auto___34527]));

var G__34528 = (i__7485__auto___34527 + (1));
i__7485__auto___34527 = G__34528;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__34520){
...
var args = map__34521__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__34521,map__34521__$1,args){
return (function() { 
var G__34529__delegate = function (p__34523){
...
while (G__34530__i < G__34530__a.length) {G__34530__a[G__34530__i] = arguments[G__34530__i + 0]; ++G__34530__i;}
  p__34523 = new cljs.core.IndexedSeq(G__34530__a,0);
} 
return G__34529__delegate.call(this,p__34523);};
G__34529.cljs$lang$maxFixedArity = 0;
G__34529.cljs$lang$applyTo = (function (arglist__34531){
var p__34523 = cljs.core.seq(arglist__34531);
return G__34529__delegate(p__34523);
});
G__34529.cljs$core$IFn$_invoke$arity$variadic = G__34529__delegate;
return G__34529;
})()
;
;})(map__34521,map__34521__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq34519){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34519));
});
