...
var args34484 = [];
var len__7484__auto___34487 = arguments.length;
var i__7485__auto___34488 = (0);
while(true){
if((i__7485__auto___34488 < len__7484__auto___34487)){
args34484.push((arguments[i__7485__auto___34488]));

var G__34489 = (i__7485__auto___34488 + (1));
i__7485__auto___34488 = G__34489;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34484.length)].join('')));
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__34494){
var map__34497 = p__34494;
...
var args = map__34497__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__34497__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__34497,map__34497__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34491_SHARP_){
return item_renderer.call(null,p1__34491_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34497,map__34497__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__34497,map__34497__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34492_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__34492_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34497,map__34497__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__34497,map__34497__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__34493_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__34493_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__34497,map__34497__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__7484__auto___34506 = arguments.length;
var i__7485__auto___34507 = (0);
while(true){
if((i__7485__auto___34507 < len__7484__auto___34506)){
args__7491__auto__.push((arguments[i__7485__auto___34507]));

var G__34508 = (i__7485__auto___34507 + (1));
i__7485__auto___34507 = G__34508;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__34500){
...
var args = map__34501__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__34501,map__34501__$1,args){
return (function() { 
var G__34509__delegate = function (p__34503){
var map__34504 = p__34503;
var map__34504__$1 = ((((!((map__34504 == null)))?((((map__34504.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34504.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34504):map__34504);
var args__$1 = map__34504__$1;
...
while (G__34510__i < G__34510__a.length) {G__34510__a[G__34510__i] = arguments[G__34510__i + 0]; ++G__34510__i;}
  p__34503 = new cljs.core.IndexedSeq(G__34510__a,0);
} 
return G__34509__delegate.call(this,p__34503);};
G__34509.cljs$lang$maxFixedArity = 0;
G__34509.cljs$lang$applyTo = (function (arglist__34511){
var p__34503 = cljs.core.seq(arglist__34511);
return G__34509__delegate(p__34503);
});
G__34509.cljs$core$IFn$_invoke$arity$variadic = G__34509__delegate;
return G__34509;
})()
;
;})(map__34501,map__34501__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq34499){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34499));
});


//# sourceMappingURL=selection_list.js.map?rel=1485243280481